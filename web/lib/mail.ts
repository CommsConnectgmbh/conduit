...
export async function sendOtpMail(to: string, code: string) {
  ...
  <table width="100%" cellpadding="0" cellspacing="0" style="max-width:480px;margin:0 auto;background:#ffffff;border-radius:16px;overflow:hidden;border:1px solid #ebebed">
    <tr><td style="padding:32px 32px 16px 32px">
      ...
      <div style="font-size:22px;font-weight:600;line-height:1.3;margin-bottom:8px">Dein Anmelde-Code</div>
      <div style="font-size:14px;color:#52525b;margin-bottom:24px">Gültig 10 Minuten. Wenn du das nicht warst, ignoriere diese Mail.</div>
    ...
    <tr><td style="padding:0 32px 28px 32px;font-size:12px;color:#a1a1aa">
      Diese Mail kommt vom privaten Login deiner Bridge zum Mac mini.
    </td></tr>
  </table></body></html>`;
